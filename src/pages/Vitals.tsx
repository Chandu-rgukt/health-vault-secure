...
import { setSelectedVitalType, setDateRange, VITAL_TYPES } from '@/store/slices/vitalsSlice';
...
const Vitals = () => {
  ...
  const { vitals, isLoading, selectedVitalType, dateRange, fetchVitals, recordVital, deleteVital } = useVitals();
  ...
  const selectedVitalInfo = VITAL_TYPES.find((v) => v.value === formData.vitalType);

  const handleRecordVital = async () => {
    if (!formData.vitalType || !formData.value) return;

    setIsRecording(true);
    const vitalInfo = VITAL_TYPES.find((v) => v.value === formData.vitalType);
  ...
  const chartData = vitals
    .filter((v) => selectedVitalType === 'all' || v.vital_type === selectedVitalType)
    .slice(0, 30)
    .reverse()
    .map((v) => ({
    ...
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-display font-bold text-foreground">Vitals Tracking</h1>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle className="font-display">Record New Vital</DialogTitle>
                <DialogDescription>
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData({ ...formData, vitalType: value })}
                  >
                    <SelectTrigger>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={isRecording || !formData.vitalType || !formData.value}
            ...
            <div className="flex flex-wrap gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => dispatch(setSelectedVitalType(value))}
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    dispatch(setDateRange({ ...dateRange, endDate: e.target.value }))
                  }
                />
              </div>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  {selectedVitalType === 'all'
                    ...
                    : `Showing ${VITAL_TYPES.find((v) => v.value === selectedVitalType)?.label}`}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {chartData.length > 0 ? (
                  <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={chartData}>
                      ...
                      <Line
                        ...
                        stroke={
                          selectedVitalType !== 'all'
                            ? getVitalColor(selectedVitalType)
                            : 'hsl(var(--primary))'
                        }
                        strokeWidth={2}
                  ...
                  <div className="h-[400px] flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">No vital data to display</p>
                      <p className="text-sm text-muted-foreground mt-1">
                        Record your first vital to see trends
                      </p>
                    </div>
                  </div>
                )}
          ...
          <TabsContent value="table">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>All your recorded health measurements</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      ...
                      <TableBody>
                        {vitals.map((vital) => {
                          const vitalInfo = VITAL_TYPES.find((v) => v.value === vital.vital_type);
                          return (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Click "Record Vital" to add your first measurement
                    </p>
                  </div>
                )}
              </CardContent>
