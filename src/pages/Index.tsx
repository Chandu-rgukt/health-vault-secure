  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container py-20 text-center animate-fade-in-up">
        ...
        <h1 className="text-4xl md:text-6xl font-display font-bold text-foreground max-w-4xl mx-auto leading-tight">
      ...
      <section className="container py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-card shadow-lg border-0 hover:shadow-xl transition-shadow">
