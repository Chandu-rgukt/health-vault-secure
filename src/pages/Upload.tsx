...
const Upload = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!file || !formData.title || !formData.reportType || !formData.reportDate) return;
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center animate-scale-in">
            ...
            <h2 className="text-2xl font-display font-bold mb-2">Upload Successful!</h2>
  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground">Upload Report</h1>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                disabled={isLoading || !file || !formData.title || !formData.reportType || !formData.reportDate}
              >
                {isLoading ? (
                  <>
