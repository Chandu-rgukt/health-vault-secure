  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-3/4 border-r animate-in slide-in-from-left sm:w-sm",
        right: "inset-y-0 right-0 h-full w-3/4 border-l animate-in slide-in-from-right sm:w-sm",
      },
    },
    defaultVariants: {
      side: "right",
